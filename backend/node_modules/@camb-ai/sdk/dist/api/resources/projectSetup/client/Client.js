...
export class ProjectSetupClient {
    ...
    async __createProject(request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                ...
                environments.CambApiEnvironment.Default, "project-setup"),
            method: "POST",
            headers: _headers,
     ...
     *     })
     */
    createProjectSetupTaskStatus(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__createProjectSetupTaskStatus(request, requestOptions));
    }
    async __createProjectSetupTaskStatus(request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                (await core.Supplier.get(this._options.environment)) ??
                environments.CambApiEnvironment.Default, `project-setup/${core.url.encodePathParam(taskId)}`),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
     ...
     *     })
     */
    getProjectSetupResult(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getProjectSetupResult(request, requestOptions));
    }
    async __getProjectSetupResult(request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                (await core.Supplier.get(this._options.environment)) ??
                environments.CambApiEnvironment.Default, `project-setup-result/${core.url.encodePathParam(runId)}`),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/project-setup-result/{run_id}");
    }
    /**
     ...
     *     })
     */
    getProjectSetupRunsResults(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getProjectSetupRunsResults(request, requestOptions));
    }
    async __getProjectSetupRunsResults(request, requestOptions) {
        ...
        const _response = await core.fetcher({
            url: core.url.join((await core.Supplier.get(this._options.baseUrl)) ??
                (await core.Supplier.get(this._options.environment)) ??
                environments.CambApiEnvironment.Default, "project-setup-results"),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
